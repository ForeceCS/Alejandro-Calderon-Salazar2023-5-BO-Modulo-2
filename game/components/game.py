...
class Game:
    def __init__(self):
        ...
        self.x_pos_bg = 0
        self.y_pos_bg = 0
  # Crear instancias de los objetos principales del juego      
        self.player = Spaceship()
        self.enemy_manager = EnemyManager()
        self.bullet_manager = BulletManager()      
        self.power_manager = PowerManager()
        self.listvalues = 0    
  # Variables para almacenar datos del juego           
    ...
    def run(self):
  #reiniciamos los administradores      
    ...
    def update(self):
        ...
        # Aumentar el poder de disparo si está activo        
        if self.player.fireshot: 
            self.bullet_manager.fire = 3
        else: 
            self.bullet_manager.fire = 1 
  # Obtener entrada del usuario y actualizar objetos del juego    
...
# Detener la música de inicio si el juego está en marcha
...
# Mostrar el menú antes de comenzar el juego
    def show_menu(self):
        ...
        if self.death_count == 0:
            ...
            #Mostramos el gameover y puntuacion
   ...
   # Actualizar el puntaje y el puntaje más alto alcanzado      
 ...
 # Actualizar la cantidad de muertes
